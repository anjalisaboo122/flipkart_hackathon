...
st.sidebar.markdown(
    ...
    <a href="https://huggingface.co/spaces/aadizeplfn/IllegalParkingDetector" target="_blank" style="display:flex; align-items:center; justify-content:center; gap:10px; padding:14px 16px; margin: 25px 0 10px 0; border-radius:10px; background:linear-gradient(135deg, rgba(139,121,242,0.1) 0%, rgba(91,157,240,0.1) 100%); border:1px solid rgba(139,121,242,0.4); color:#8b79f2; text-decoration:none; font-family:'Inter', sans-serif; font-weight:700; font-size:14px; letter-spacing:0.5px; box-shadow:0 0 15px rgba(139,121,242,0.15);">
